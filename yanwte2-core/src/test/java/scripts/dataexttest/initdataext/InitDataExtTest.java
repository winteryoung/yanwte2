package scripts.dataexttest.initdataext;
...
import scripts.dataexttest.initdataext.testmaterial.multiservices.n1.DataExtN1;
import scripts.dataexttest.initdataext.testmaterial.multiservices.n2.DataExtN2;
...
import scripts.dataexttest.initdataext.testmaterial.simple.ns1.DataExtInitializerImplNs1;
import scripts.dataexttest.initdataext.testmaterial.simple.ns2.DataExtInitializerImplNs2;
...
public class InitDataExtTest {
    ...
    public void testDataExtensionInitializer_multiServices() {
        ...
        DataExtN1 dataExtN1 =
                context.getDataExt(
                        "scripts.dataexttest.initdataext.testmaterial.multiservices.n1");
        Assertions.assertThat(dataExtN1.getI()).isEqualTo(4);
        DataExtN2 dataExtN2 =
                context.getDataExt(
                        "scripts.dataexttest.initdataext.testmaterial.multiservices.n2");
