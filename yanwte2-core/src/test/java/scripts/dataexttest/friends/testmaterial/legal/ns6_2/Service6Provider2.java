package scripts.dataexttest.friends.testmaterial.legal.ns6_2;
...
public class Service6Provider2 implements Service6 {
    ...
    public Void apply(Context6 context6) {
        DataExt6_1 dataExt6_1 = context6.getDataExt("scripts.dataexttest.friends.testmaterial.legal.ns6_1");
        dataExt6_1.setI(4);
        return null;
    }
}
